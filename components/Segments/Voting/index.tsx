...
const images = [
  ...
  {
    url: "/president.png",
    title: "Elections for a president",
    width: "70vw",
    end: "21.12.2020",
    start: "01.10.2020",
    voted: false,
                  ...
                  image =>
                    ((container.state.search &&
                      (image.title.includes(container.state.search) ||
                        image.start.includes(container.state.search) ||
                      ...
                      >
                        ...
                        <span className={classes.imageButton}>
                          <Typography
                            ...
                            onClick={() => Router.push("/vote?id=" + image.id)}
                          >
                            {image.title}
                        ...
                        <Chip
                          avatar={<AlarmOnIcon />}
                          label={"Start: " + image.start}
                          style={{
                            left: 5,
                            bottom: 5,
                            position: "absolute",
                            backgroundColor: "rgb(91,221,64)"
                          }}
                        />
                        <Chip
                          deleteIcon={
